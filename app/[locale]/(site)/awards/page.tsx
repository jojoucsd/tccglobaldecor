          ...
          return (
            ...
            >
              ...
              <div className="pointer-events-none absolute inset-x-0 bottom-0">
                <div className="h-20 bg-gradient-to-t from-black/45 via-black/20 to-transparent" />
                <div className="absolute inset-x-0 bottom-0 pb-4 px-4">
                  <h3 className="text-center text-white text-base font-semibold drop-shadow-sm">{title}</h3>
                </div>
              </div>
            </div>
          );
